...
<nav class="main-header navbar navbar-expand navbar-olive navbar-light">
  ...
  <form class="form-inline ml-3" method="POST" action="?brgypage=search">
   ...
   <div class="input-group input-group-sm">
      ...
      <input class="form-control form-control-navbar" type="search" placeholder="Search" name="search" id="search" aria-label="Search" required>
  ...
  <ul class="navbar-nav ml-auto">
    ...
    <li class="nav-item dropdown">
      ...
      <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
		...
		<div class="dropdown-divider"></div>
        <a href="?brgypage=userprofile" class="dropdown-item">
