...
if($usertype=="SuperAdmin"){
  ...
  $where = "where usertype='BarangayCaptain' AND useractive='0' ORDER BY user_id ASC";
}elseif($usertype=="BarangayCaptain"){
  $where = "WHERE usertype NOT IN('SuperAdmin','Administrator','BarangayCaptain') AND brgy_id_fk='{$brgy_id}' && useractive='0' ORDER BY user_id ASC";
}elseif($usertype=="Kagawad" || $usertype=="Secretary") {
  $where = "WHERE usertype IN('Kagawad','Secretary') AND brgy_id_fk='{$brgy_id}' && useractive='0' ORDER BY user_id ASC";
}
?>
  <div class="content-wrapper" style="min-height: 1589.56px;">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Users List<a href="?brgypage=userlist" class="btn btn-success btn-xs"><i class="fa fa-check"></i>&nbsp;Activated Users</a>
          </h1>
			</div>
          <div class="col-sm-6">
    ...
    <section class="content">
      ...
      <div class="card">
        <div class="card-header">
          ...
          <h3 class="card-title">List of Deactivated Users<a class="btn btn-success btn-sm" data-toggle="modal" title="Add New User" data-target="#modal-user"><i class="fa fa-user" style="color:white;"></i></a></h3>
        <?php }elseif($usertype=="BarangayCaptain"){?>
          <h3 class="card-title">List of Deactivated Users<a class="btn btn-success btn-sm" data-toggle="modal" title="Add New User" data-target="#modal-userunderbrgycaptain"><i class="fa fa-user" style="color:white;"></i></a></h3>
        <?php }?>
        </div>
          ...
          <table id="example1" class="table table-bordered table-hover dataTable" role="grid" aria-describedby="example2_info">
              ...
              <tbody>
                ...
                <tr role="row" class="even">
					...
					<td>
						<button type="button" id="btn_user_id_<?php echo $rs_userval['user_id']; ?>" class="btn btn-success btn-xs" title="Activate this User" data-toggle="tooltip" value="<?php echo $rs_userval['user_id']; ?>" onclick="ActivatUser('<?php echo $rs_userval['user_id']; ?>');"><i class="fa fa-check"></i></button>
					</td>
              </tr>
               <?php
               $c++;
